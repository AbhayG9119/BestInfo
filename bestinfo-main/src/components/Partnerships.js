  ...
  return (
    ...
    >
      <div className="partnerships-container">
        ...
        {/* Desktop Grid View */}
        <motion.div
          className="logo-grid desktop-grid"
          variants={containerVariants}
        >
        ...
        <div className="logo-marquee mobile-marquee" aria-label="Partner logos marquee" role="list">
          <div className="marquee-track">
            {marqueeLogos.map((logo, index) => (
              <div key={index} className="marquee-item" role="listitem">
                <img src={logo} alt={`Partner ${index % logos.length + 1}`} loading="lazy" />
              </div>
            ))}
          </div>
        </div>
